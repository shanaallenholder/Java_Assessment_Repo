...
/**
 * The Ingredient class represents a Ingredient entity with details such as the
 * ingredients name, weight and dietry restrictions.
 * I will build on this class to create more features for my recipe book, as i
 * build on savoury recipes too.
 * 
 */
public class Ingredient {
     ...
     * 
     * @param weight of the ingredient is set to ingredient only if more than 0,
     *               weight can not be less than, if no then an exception is thrown.
     */
